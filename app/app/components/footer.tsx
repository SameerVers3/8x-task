...
const socials = [
  { icon: XIcon, href: "https://twitter.com/fluidthoughts", label: "X / Twitter" },
  { icon: GitHubIcon, href: "https://github.com/fluidthoughts", label: "GitHub" },
  { icon: InstagramIcon, href: "https://instagram.com/fluidthoughts", label: "Instagram" },
  { icon: YouTubeIcon, href: "https://youtube.com/@fluidthoughts", label: "YouTube" },
];
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1280px] px-6 py-20 md:px-16 md:py-24">
              ...
              <ul className="space-y-2.5">
                {group.links.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-sm text-[var(--text-secondary)] transition-colors hover:text-[var(--accent-solid)]"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-[var(--border-subtle)] pt-8 sm:flex-row">
          ...
          <p className="flex items-center gap-1 text-[0.8125rem] text-[var(--text-tertiary)]">
            Made with <Heart className="h-3 w-3 text-[var(--danger)]" /> for creators
          </p>
        </div>
      </div>
    </motion.footer>
